...
- (void)loadLocalRows{
	@synchronized(self){
		...
		self.totalCount = [dao getTableRowCount:IreferConstraints.specialityTableName searchValue:self.searchBar.text];
		
		self.dataSource = [dao getTableRowList:IreferConstraints.specialityTableName searchValue:self.searchBar.text limit:self.currentLimit];
