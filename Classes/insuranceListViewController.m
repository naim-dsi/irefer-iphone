...
- (void)loadLocalRows{
	@synchronized(self){
		...
		self.totalCount = [dao getTableRowCount:IreferConstraints.insuranceTableName searchValue:self.searchBar.text];
		
		self.dataSource = [dao getTableRowList:IreferConstraints.insuranceTableName searchValue:self.searchBar.text limit:self.currentLimit];
